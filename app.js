...
function autoPS(m){
if(m < 4.5) return {power:60, category:'Стандарт', price:350}
if(m <= 7.5) return {power:100, category:'Стандарт', price:550}
if(m <= 12.5) return {power:150, category:'Стандарт', price:705}
if(m <= 15) return {power:200, category:'Стандарт', price:775}
